...
### 1. [Czech Bank Dataset — Python Data Analytics Class Exercise](./01-czech-bank-class-exercise/)
...
### 2. [Grocery/Retail Dataset — Data Analytics Class Exercise](./02-grocery-retail-class-exercise/)

A class exercise demonstrating practical data analysis and interpretation
using a grocery/retail dataset.

### 3. [Healthcare Billing & Operational Data Analysis](./03-healthcare-billing-operational-analysis/)
